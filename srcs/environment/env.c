...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/20 10:54:08 by arepsa            #+#    #+#             */
/*   Updated: 2023/11/20 17:10:07 by fduque-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_env_list(t_shell *shell)
{
	...
	i = 0;
	while (shell->mini_env[i] != NULL)
	{
		key = get_key(shell->mini_env[i]);
		value = get_value(shell->mini_env[i]);
